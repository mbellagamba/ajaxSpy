...
MockHttpRequest.prototype = {
  ...
  open: function (method, url, async, user, password) {
    ...
    // method could be DELETE, GET, HEAD, OPTIONS, POST, PUT
    this.method = method;
  ...
  abort: function () {
    if(this.sent || this.readyState != this.UNSENT && this.readyState != this.OPENED){
  ...
  makeXMLResponse: function (data) {
    ...
    if (mimetype === null || mimetype == 'text/xml' || mimetype == 'application/xml' ||
